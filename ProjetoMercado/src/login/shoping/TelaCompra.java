...
public class TelaCompra extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Nr de conta");

        btnC.setText("Comprar");
    ...
    private void btnCActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCActionPerformed
        ...
        Ultima u = new Ultima();
        String n = txtConta.getText();
        int s = n.length();
        if(s<10) JOptionPane.showMessageDialog(rootPane,"O numero de conta \ndeve conter 10 caracteres");
        else if(s==10){
